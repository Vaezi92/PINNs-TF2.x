...
"""   
sys.path.append('I:\litterature Review\PINNs-TF2-Conduction\Modules')
...
for n_hidden_layers in [4]:
    for n_hidden_neurons in [15]:
        ...
        X_BC, Y_BC, u_BC = BC.Temperature(NF, NFN, NFR, BCType, X, Y, IDS)
        ...
        u_collocated, u_BC = PINN.PINN(batch_size, train_dataset, X_collocated, Y_collocated, X_BC, Y_BC, u_BC, NC, n_hidden_layers, n_hidden_neurons)
        
        "###########################    Writing Results    ##########################"
        sys.path.append('I:\litterature Review\PINNs-TF2-Conduction\Modules')
        import WritingResults as WR
        WR.Contour(NP, NC, NF, NR, NFR, BCType, BCTitle, IDS, X, Y, Z, NFN, NFW, NFF, NFI, NFO, NFS, X_collocated, Y_collocated, u_collocated, X_BC, Y_BC, u_BC, NX, NY, DA, A, n_hidden_layers, n_hidden_neurons)
